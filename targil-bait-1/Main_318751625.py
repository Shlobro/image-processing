...
The implementation below mirrors the robust reference solution while keeping the
required file layout.  It performs advanced separator estimation, refined Hough
filtering, and safe rendering so the annotated images match the expected sample.
"""
